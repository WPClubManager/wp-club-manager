 ...
 */
	...
	class WPCM_Taxonomy_Order {
		...
		// 	if ( ! defined( 'WPCM_NAME' ) ) {
		// 		define( 'WPCM_NAME', plugin_basename( __FILE__ ) );
		// 	}

		// 	if ( ! defined( 'WPCM_OPTION_NAME' ) ) {
		// 		define( 'WPCM_OPTION_NAME', 'yikes_simple_taxonomy_ordering_options' );
		// 	}
		// }
		...
		// 		include WPCM_PATH . 'lib/options.php';
		// 	}
		// }
		...
		public function enqueue() {
			//$min = wpcm_maybe_minified();
			$tax = function_exists( 'get_current_screen' ) ? get_current_screen()->taxonomy : '';
			//wp_enqueue_style( 'wpcm-tax-drag-drop-styles', WPCM_URL . "lib/css/wpcm-tax-drag-drop{$min}.css", array(), WPCM_VERSION, 'all' );
