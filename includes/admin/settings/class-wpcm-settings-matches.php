...
class WPCM_Settings_Matches extends WPCM_Settings_Page {
	...
	public function get_settings() {
		...
		$settings = array(
			...
			array( 'title' => __( 'Match Settings', 'wp-club-manager' ), 'type' => 'title', 'desc' => '', 'id' => 'match_format_options' ),
		...
		$settings[] = array( 'type' 	=> 'sectionend', 'id' => 'match_format_options');

		$settings[] = array( 'title' 	=> __( 'Match Lineup', 'wp-club-manager' ), 'type' => 'title', 'desc' => '', 'id' 	   => 'match_lineup_display_options' );
