...
<div id="message" class="updated wpclubmanager-message wpcm-connect">
	...
	<p class="submit"><a class="button-primary" href="<?php echo esc_url( admin_url( 'admin.php?page=wpcm-status' ) ); ?>"><?php _e( 'System Status', 'wp-club-manager' ); ?></a> <a class="skip button-primary" href="<?php echo esc_url( wp_nonce_url( add_query_arg( 'wpcm-hide-notice', 'template_files' ), 'wpclubmanager_hide_notices_nonce', '_wpcm_notice_nonce' ) ); ?>"><?php _e( 'Hide this notice', 'wp-club-manager' ); ?></a></p>
</div>
