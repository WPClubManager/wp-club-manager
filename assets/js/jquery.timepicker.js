...
( function( factory ) {
    ...
    var methods = {
        init: function( options ) {
            return this.each( function() {
                ...
                for ( var key in $.fn.wpcmtimepicker.defaults ) {
                    if ( self.data( key ) ) {
                        attributeOptions[ key ] = self.data( key );
                    }
                }

                var settings = $.extend( {}, $.fn.wpcmtimepicker.defaults, options, attributeOptions );
    ...
    // Plugin entry
    $.fn.wpcmtimepicker = function( method ) {
